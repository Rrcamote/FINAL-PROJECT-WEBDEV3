  ...
  <div class="content-wrapper" style="background-color: #134b5f">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-warning">SCHEDULE</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr>
                  ...
                  <td>
                    <button style="width: 100px; margin-left: 50px" class="btn btn-success  sched_change" id="<?php echo $row['emp_id']; ?>">Edit</button>
                  </td>
                </tr>
                <?php
                }
